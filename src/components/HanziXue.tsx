...
const strokeVariants: Variants = {
  ...
  visible: {
    ...
    pathLength: 1,
    transition: {
      pathLength: { duration: 1.15, ease: [0.65, 0, 0.35, 1] },
...
export function HanziXue() {
  ...
  return (
    <section className="mx-auto flex w-full max-w-sm flex-col items-center gap-5 rounded-lg border border-zinc-200 bg-white p-6 text-[#1a1a1a] shadow-sm dark:border-zinc-800 dark:bg-zinc-950 dark:text-[#f5f5f5]">
      <motion.svg
        key={animationKey}
        viewBox="0 0 1024 1024"
        xmlns="http://www.w3.org/2000/svg"
        role="img"
        aria-label="Animasi urutan goresan hanzi 學"
      ...
      <button
        type="button"
        className="rounded-md bg-zinc-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-zinc-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:ring-offset-2 dark:bg-zinc-100 dark:text-zinc-950 dark:hover:bg-zinc-300 dark:focus-visible:ring-zinc-300 dark:focus-visible:ring-offset-zinc-950"
